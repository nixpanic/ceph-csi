...
make preflight
make up -j4 BOX_OS=centos VAGRANT_DEFAULT_PROVIDER=libvirt KUBERNETES_VERSION=1.17.4 MASTER_CPUS=4 MASTER_MEMORY_SIZE_GB=8 NODE_COUNT=2 NODE_MEMORY_SIZE_GB=4 DISK_COUNT=2 DISK_SIZE_GB=25
make versions
make status
