...
vagrant ssh -c 'cd go/src/github.com/ceph/ceph-csi && ./scripts/centos-ci/install-deps.sh && source /opt/rh/rh-ruby26/enable && source /opt/rh/go-toolset-7/enable && make test'
RET=$?
