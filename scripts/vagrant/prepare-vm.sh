...
sudo docker pull quay.io/nixpanic/cephcsi:testing_rbd_go-ceph_connect
sudo docker tag quay.io/nixpanic/cephcsi:testing_rbd_go-ceph_connect quay.io/cephcsi/cephcsi:canary
