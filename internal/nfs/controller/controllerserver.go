...
import (
	...
	cephfscore "github.com/ceph/ceph-csi/internal/cephfs/core"
...
func NewControllerServer(d *csicommon.CSIDriver) *ControllerServer {
	...
	cephfscore.VolJournal = journal.NewCSIVolumeJournalWithNamespace(cephfs.CSIInstanceID, fsutil.RadosNamespace)
...
func (cs *ControllerServer) CreateVolume(
	...
	nfsVolume, err := NewNFSVolume(res.Volume.VolumeId)
	if err != nil {
		return nil, status.Error(codes.InvalidArgument, err.Error())
	}
