...
import (
	...
	"github.com/ceph/ceph-csi/internal/smb/controller"
	"github.com/ceph/ceph-csi/internal/smb/identity"
	"github.com/ceph/ceph-csi/internal/smb/nodeserver"
	"github.com/ceph/ceph-csi/internal/util"
	"github.com/ceph/ceph-csi/internal/util/log"
)

// smbDriver contains the default identity and controller struct.
...
// assert that smbDriver implements the Driver interface.
var _ driver.Driver = &smbDriver{}

// Run start a non-blocking grpc controller,node and identityserver for
// ceph CSI driver which can serve multiple parallel requests.
func (fs *smbDriver) Run(conf *util.Config) {
