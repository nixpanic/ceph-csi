...
func (rbdVol *rbdVolume) Exists(ctx context.Context) (bool, error) {
	...
	imageData, err := volJournal.CheckReservation(ctx, rbdVol.Monitors, rbdVol.Creds, rbdVol.JournalPool,
	...
	if err != nil {
		if _, ok := err.(ErrImageNotFound); ok {
			err = volJournal.UndoReservation(ctx, rbdVol.Monitors, rbdVol.Creds, rbdVol.JournalPool, rbdVol.Pool,
	...
	rbdVol.VolID, err = util.GenerateVolID(ctx, rbdVol.Monitors, rbdVol.Creds, imageData.ImagePoolID, rbdVol.Pool,
